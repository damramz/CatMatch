...
export default function SwipeScreen({
  ...
  const [floatingHearts, setFloatingHearts] = useState<Array<{ id: string; x: number; y: number; size: number }>>([]);

  const currentCat = cats[currentCatIndex];
  const progress = cats.length > 0 ? ((currentCatIndex + 1) / cats.length) * 100 : 0;
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-teal-50">
      ...
      <main className="max-w-md mx-auto px-4 py-6">
        ...
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-slate-700 mb-2">Find Your Purrfect Match</h2>
